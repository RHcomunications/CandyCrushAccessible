...
namespace CandyCrushAccessible.Engine
{
    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, string> Spanish = new Dictionary<string, string>
        {
            ...
            {"obj.ingredient", "Lleva {0} {1} a la parte inferior (fila 8) en {2} movimientos"},
            {"obj.timed", "Consigue {0} puntos en {1} segundos"},
            {"obj.order", "Completa los pedidos en {0} movimientos"},
            {"obj.order.specific", "Recolecta {0} en {1} movimientos"},
            {"order.candy", "{0} {1}"},
            {"order.striped", "{0} caramelos rayados"},
            {"order.wrapped", "{0} caramelos envueltos"},
            {"order.colorbomb", "{0} bombas de color"},
            {"order.fish", "{0} peces de gelatina"},
            {"order.remaining", "Pedidos restantes: {0}"},
            {"order.progress.item", "{0} de {1} recolectados ({2})"},
            ...
            {"ingredient.status.detail", "Ingredientes: {0} de {1} recolectados. {2}"},
            {"ingredient.board.locations", "En el tablero: {0}"},
            {"ingredient.none.onboard", "Esperando próxima aparición en el tablero"},
            {"ingredient.spawned", "¡Nuevo ingrediente en {0}: {1}! Llévalo a la fila 8"},
            {"timed.status.detail", "Tiempo restante: {0}s de {1}s ({2}% del tiempo restante)"},
            {"order.status.detail", "Progreso de pedidos: {0}"},
            ...
            {"options.debug", "Maxear todo (solo desarrollo)"},
            {"options.debug.maxed", "Modo desarrollador: recursos al máximo. {0} lingotes, {1} monedas, 99 vidas, 50 de cada potenciador y el bono diario disponible."},
            ...
            {"complete.stars.of", "Estrellas: {0} de 3"},
            {"lives.count", "Vidas: {0}"},
            ...
            {"failed.extramoves", "Comprar 5 movimientos por {0} lingotes de oro"},
            {"failed.menu", "Menú"},
            ...
            {"shop.title", "Tienda"},
            {"shop.balance.gold", "Lingotes: {0}"},
            {"shop.balance.coins", "Monedas: {0}"},
            {"shop.balance.all", "Tienes {0} lingotes de oro y {1} monedas"},
            {"shop.section.boosters", "Potenciadores. Se pagan con lingotes."},
            {"shop.section.packs", "Paquetes de lingotes. Se pagan con monedas."},
            {"shop.section.daily", "Bono diario. Regalo gratuito."},
            ...
            {"shop.goldpack1", "Paquete Chico: 10 Lingotes"},
            {"shop.goldpack2", "Paquete Mediano: 30 Lingotes"},
            {"shop.goldpack3", "Paquete Grande: 70 Lingotes"},
            {"shop.daily", "Bono diario"},
            {"shop.price", "Precio: {0} lingotes"},
            {"shop.price.coins", "Cuesta {0} monedas"},
            {"shop.locked", "Bloqueado"},
            {"shop.unlock.at", "Se desbloquea en nivel {0}"},
            {"shop.owned", "Comprado"},
            {"shop.owned.count", "Tienes {0}"},
            {"shop.purchased", "¡Comprado!"},
            {"shop.pack.purchased", "¡Comprado! Recibiste {0} lingotes de oro."},
            {"shop.notenough", "No tienes suficientes lingotes. Necesitas {0}."},
            {"shop.coins.notenough", "No tienes suficientes monedas. Necesitas {0}."},
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            {"obj.ingredient", "Bring {0} {1} down to the bottom (row 8) in {2} moves"},
            {"obj.timed", "Score {0} points in {1} seconds"},
            {"obj.order", "Complete the orders in {0} moves"},
            {"obj.order.specific", "Collect {0} in {1} moves"},
            {"order.candy", "{0} {1} candies"},
            {"order.striped", "{0} striped candies"},
            {"order.wrapped", "{0} wrapped candies"},
            {"order.colorbomb", "{0} color bombs"},
            {"order.fish", "{0} jelly fish"},
            {"order.remaining", "Remaining orders: {0}"},
            {"order.progress.item", "{0} of {1} collected ({2})"},
            ...
            {"ingredient.status.detail", "Ingredients: {0} of {1} collected. {2}"},
            {"ingredient.board.locations", "On board: {0}"},
            {"ingredient.none.onboard", "Waiting for next spawn on board"},
            {"ingredient.spawned", "New ingredient at {0}: {1}! Bring it to row 8"},
            {"timed.status.detail", "Time remaining: {0}s of {1}s ({2}% time remaining)"},
            {"order.status.detail", "Orders progress: {0}"},
            ...
            {"options.debug", "Max everything (dev only)"},
            {"options.debug.maxed", "Developer mode: resources maxed. {0} gold bars, {1} coins, 99 lives, 50 of each booster and the daily bonus available."},
            ...
            {"complete.stars.of", "Stars: {0} of 3"},
            {"lives.count", "Lives: {0}"},
            ...
            {"failed.retry", "Retry"},
            {"failed.extramoves", "Buy 5 moves for {0} gold bars"},
            {"failed.menu", "Menu"},
            ...
            {"shop.title", "Shop"},
            {"shop.balance.gold", "Gold Bars: {0}"},
            {"shop.balance.coins", "Coins: {0}"},
            {"shop.balance.all", "You have {0} gold bars and {1} coins"},
            {"shop.section.boosters", "Boosters. Paid with gold bars."},
            {"shop.section.packs", "Gold bar packs. Paid with coins."},
            {"shop.section.daily", "Daily bonus. Free gift."},
            ...
            {"shop.goldpack1", "Small Pack: 10 Gold Bars"},
            {"shop.goldpack2", "Medium Pack: 30 Gold Bars"},
            {"shop.goldpack3", "Large Pack: 70 Gold Bars"},
            {"shop.daily", "Daily Bonus"},
            {"shop.price", "Price: {0} gold bars"},
            {"shop.price.coins", "Costs {0} coins"},
            {"shop.locked", "Locked"},
            {"shop.unlock.at", "Unlocks at level {0}"},
            {"shop.owned", "Purchased"},
            {"shop.owned.count", "You have {0}"},
            {"shop.purchased", "Purchased!"},
            {"shop.pack.purchased", "Purchased! You received {0} gold bars."},
            {"shop.notenough", "Not enough gold bars. You need {0}."},
            {"shop.coins.notenough", "Not enough coins. You need {0}."},
