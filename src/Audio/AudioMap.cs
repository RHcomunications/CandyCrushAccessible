...
namespace CandyCrushAccessible.Audio
{
    public static class AudioMap
    {
        private static readonly Dictionary<string, string> Map = new Dictionary<string, string>
        {
            ...
            {"ingredient", "all_aboard1.wav"},
            {"ingredient2", "tickets_please1.wav"},
            {"nut", "nut_out1.wav"},
        ...
        {
            {"candy", "button_press.wav"},
            {"match1", "button_press.wav"},
            {"match2", "button_press.wav"},
            {"match3", "button_press.wav"},
            {"match4", "button_press.wav"},
            {"match5", "button_press.wav"},
            {"match6", "button_press.wav"},
            {"match7", "button_press.wav"},
            {"match8", "button_press.wav"},
            {"match9", "button_press.wav"},
            {"match10", "button_press.wav"},
            {"match11", "button_press.wav"},
            {"match12", "button_press.wav"},
            {"jelly", "swoosh_ut.wav"},
            {"jelly2", "swoosh_ut.wav"},
            {"win", "button_press.wav"},
            {"lose", "button_press.wav"},
            {"colorbomb_created", "striped_candy_created1.wav"},
            {"wrapped_created", "striped_candy_created1.wav"},
            {"supercolorbomb", "colour_bomb_created.wav"},
            {"ingredient", "candy_land1.wav"},
            {"ingredient2", "candy_land1.wav"},
            {"square", "swoosh_ut.wav"},
            {"square2", "swoosh_ut.wav"},
            {"lineblast", "swoosh_ut.wav"},
            {"sugar", "swoosh_ut.wav"},
            {"fish", "candy_land1.wav"},
            {"bomb", "swoosh_ut.wav"},
            {"chocolate_grow", "candy_land1.wav"},
            {"chocolate_removed", "candy_land1.wav"},
            {"licorice", "candy_land1.wav"},
            {"time_warning", "button_press.wav"}
        };
